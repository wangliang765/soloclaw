...
- Phase 2: Engineering execution capability.
  ...
  - Current inspection view: `agent session inspect <session-id> [--json]` returns a focused inspection document with state, summary, required/warning/info issues, focus paths, safe signals, next actions, and review commands for CLI/TUI/Web reuse.
