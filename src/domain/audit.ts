...
export type AuditEventType =
  ...
  | "agent.command_template_executed"
  | "completion.gate"
  | "agent.event"
  | "tool.requested"
  | "tool.approved"
  ...
  | "memory.candidate_denied"
  | "memory.candidate_approved"
  | "memory.candidate_rejected"
  | "memory.retrieved"
  | "memory.snapshot_exported"
  | "memory.snapshot_imported"
  | "memory.pre_compaction_extract"
  | "memory.provider_turn_extract"
  | "org.created"
  | "project.created"
  | "capability.granted"
